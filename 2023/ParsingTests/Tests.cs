...
namespace ParsingTests
{
    ...
    """)]
        ...
        {
            void Solve((int a, char c)[] lines)
            {
                lines.Sum(l => l.a).ShouldBe(6);
            }
    ...
    """)]
        ...
        {
            void Solve(Color[] lines)
            {
                lines.Distinct().Count().ShouldBe(3);
            }
    ...
    """)]
        ...
        {
            void Solve(JsonObject obj)
            {
                obj["a"]?.GetValue<int>().ShouldBe(42);
            }
        ...
        {
            void Solve((string name, int age) person)
            {
